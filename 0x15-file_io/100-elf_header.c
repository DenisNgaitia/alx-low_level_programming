 ...
 * @e_ident: this is pointer to array containing the ELF version.
 */
...
/**
 * main - Displays content of ELF header at the start of file
 * @argc: number of arguments supplied to program.
 * @argv: this is an array of pointers to the arguments.
 * Return: 0(success).
 * Description: If file's not an ELF File or function
 *              fails - exit code 98.
 */
